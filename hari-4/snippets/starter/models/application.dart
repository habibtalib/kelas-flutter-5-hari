...
// Model Application + enum ApplicationStatus. Lengkap dengan `toJson()`
// (body POST Latihan 7). `Application.fromJson` DIKELUARKAN — ia bergantung
// pada EntryCategory.fromString yang anda bina di Latihan 3.1 (lihat nota dalam).
...
class Application {
  ...
  // NOTA (Hari 4): `Application.fromJson` sengaja tidak disertakan dalam fail
  // starter ini kerana ia bergantung pada `EntryCategory.fromString` yang anda
  // bina di Latihan 3.1. Lab Hari 4 hanya perlu `Application(...)` + `toJson()`
  // (Latihan 7 POST). Anda boleh tambah `factory Application.fromJson` sendiri
  // sebagai latihan tambahan selepas Latihan 3 (corak sama Programme.fromJson).
